...
const fetchUserProfile = async (initialized, navigate, setUserNickname, setUserEmailAddress, setUserAvatar,setCreadit, baseUrl) => {
        ...
        try {
            ...
            if (userAvatar === null) {
                if (userAvatarUrl) {
                    ...
                    await generateAvatar(userEmailAddress, setUserAvatar, userToken, baseUrl);
                }
            } else {
                setUserAvatar(userAvatar);
            }
...
const generateAvatar = async (emailAddress, setUserAvatar, userToken, baseUrl) => {
    ...
    try {
        ...
        let config = {
            ...
            url: `${baseUrl}/v1/auth/update-profile`,
            headers: {
                accept: 'application/json',
